...
@property (nonatomic, weak) IBOutlet UILabel *moneyTitleLB;
@property (nonatomic, weak) IBOutlet UITextField *remainMoneyShowTF;
@property (nonatomic, weak) IBOutlet UIButton *moneyChangeBtn;

// 상태 표시화면(히스토리)
@property (nonatomic, weak) IBOutlet UITextView *displayView;
...
//        moneyTitleLB.font = [UIFont systemFontOfSize:15];
       [self.moneyControlArea addSubview:_moneyTitleLB];
//        [self.moneyControlArea setBackgroundColor:[UIColor blackColor]];
...
//        remainMoneyShowTF.textAlignment = NSTextAlignmentCenter;
        [self.moneyControlArea addSubview:_remainMoneyShowTF];
...
//        [moneyChangeBtn setTitleColor:[UIColor whiteColor] forState:UIControlStateNormal];
        [self.moneyControlArea addSubview:_moneyChangeBtn];
...
//    displayView.font = [UIFont systemFontOfSize:13];
